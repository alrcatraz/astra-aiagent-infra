...
Captured 2026-06-09 via `ipmitool -I lanplus` through <device> jump host.
...
```bash
# Via <device> jump host (ipmitool installed 2026-06-09)
...
# Then read SEL:
ssh <device> "ipmitool -I lanplus -H 192.168.100.27 -U <user> -P '<pass>' sel list"
```
